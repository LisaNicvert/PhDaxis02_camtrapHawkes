...
simu_file <- here("code/simulation_hawkes/out/simulationsBVL.rds")
inference_file <- here("code/simulation_hawkes/out/inferenceBVL.rds")
...
# Export plot
ggsave(here("code/simulation_hawkes/figures/simu_gamma_choice.jpeg"),
...
plot_bias(inference_bias_plot, textsize = 16) +
  xlab("To") +
  ylab("From")

ggsave(here("code/simulation_hawkes/figures/bias_gamma.jpeg"),
