...
# Export plot
ggsave(here("code/hawkes_process_simulation_example/figures/function.jpeg"),
...
plot_graph(g, 
           ...
           s = 12)
# Export plot
ggsave(here("code/hawkes_process_simulation_example/figures/graph.jpeg"),
       width = 8, height = 6, dpi = 600, units = "cm", bg = "white")
```
...
plot_observed_rate(rates, data = simul_df, 
                   ...
                   cols = cols)
# Export plot
ggsave(here("code/hawkes_process_simulation_example/figures/realization.jpeg"),
