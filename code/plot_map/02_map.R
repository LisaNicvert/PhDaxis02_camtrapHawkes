...
# --- Countries borders
southern_africa <- st_read(here("code/plot_map/shp_data/southern_africa/southern_africa.shp"))

# --- Parks
parks <- read_sf(here("code/plot_map/shp_data/reserves/reserves.shp"))
...
ggsave(here("code/plot_map/figure/map.jpeg"), 
