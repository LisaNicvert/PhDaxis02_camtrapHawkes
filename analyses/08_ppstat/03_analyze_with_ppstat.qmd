...
# Species
startknot_spp <- -ndays*0.4 # first knot (value chosen in accordance with the pilot study of Carstensen et al 2010: in their study the first knot is placed at 0.4*range)
...
#| code-fold: true
wrap_plots(glist, ncol = 5) & ylim(c(0, 0.87))
